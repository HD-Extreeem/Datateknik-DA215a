/*
 * common.h
 * Uses 3 different macros
 * First one sets a specific bit in register where we want to be set or not set
 * the second one clears a specific bit we want to be cleared
 * third one set bit levels that specify which bit is set or not.
